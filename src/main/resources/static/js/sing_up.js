...
function saveData(user) {
    ...
    commonData.append("name", user.name);
    commonData.append("email", user.email);
    commonData.append("password", user.password);
    commonData.append("phone", user.phone);
    commonData.append("address", user.address);
    $.ajax({
        url: '/save-user',
        type: 'POST',
        data: commonData,
